  ...
  badges: [
    {
      ...
      description: "Reported over 10 verified civic issues",
    ...
    },
    {
      ...
      description: "Helped Ward 42 reach 85% cleanliness rating",
      unlockedAt: "2026-08-01",
    },
    {
      id: "b3",
      name: "AI Verified Reporter",
      icon: "auto_awesome",
      description: "100% precision score on computer-vision reports",
    ...
    },
    {
      ...
      icon: "campaign",
      description: "Participated in 25+ community polls & verifications",
